...
$scope.submit=function(){
  $scope.loading=true
  $http.get("http://ec2-18-223-205-154.us-east-2.compute.amazonaws.com:3000/api/Material/"+$scope.materialCode)
    ...
    var date1 = new Date(datetime);
     ...
     for(var n=0;n<$scope.res.purchaseorder.length;n++){
      ...
      for(var k=0;k<$scope.res.purchaseorder[n].purchaseorder.batch[j].batch.invoice.length;k++){
        ...
        $scope.poData.balance=$scope.res.purchaseorder[n].purchaseorder.batch[j].batch.availableQuantity
